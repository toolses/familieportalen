...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 flex flex-col">
      ...
      <!-- Bottom nav: Dashboard, Kalender, Skole, Innstillinger -->
      <nav class="bg-white border-t border-gray-200 sticky bottom-0 z-50 safe-bottom">
        <div class="max-w-2xl mx-auto flex">
          <a routerLink="/" routerLinkActive="text-blue-600" [routerLinkActiveOptions]="{ exact: true }"
             class="flex-1 flex flex-col items-center py-2 text-gray-400 transition-colors">
            <!-- Home/Dashboard icon -->
          ...
          <a routerLink="/kalender" routerLinkActive="text-blue-600"
             class="flex-1 flex flex-col items-center py-2 text-gray-400 transition-colors">
            <!-- Calendar icon -->
          ...
          <a routerLink="/skole" routerLinkActive="text-blue-600"
             class="flex-1 flex flex-col items-center py-2 text-gray-400 transition-colors">
            <!-- School/Book icon -->
          ...
          <a routerLink="/innstillinger" routerLinkActive="text-blue-600"
             class="flex-1 flex flex-col items-center py-2 text-gray-400 transition-colors">
            <!-- Settings/Gear icon -->
